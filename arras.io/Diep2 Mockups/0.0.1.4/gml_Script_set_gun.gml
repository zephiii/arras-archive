...
var _basic, _BLANK, _drone, _swarm, _triple, _halfreload, _trap, _halfrange, _DUMMY, _over, _pound, _block, _construct, _gunner, _power, _arty, _twin, _lowpower, _lessreload, _spread, _destroy, _morerecoil, _sniper, _rifle, _halfrecoil, _hunter, _hunter2, _2reload, _preda, _assass, _mach, _blaster, _gatling, _howitzer, _flame, _bent, _ministream, _flank, _dual, _quint, _settings;
...
if (UPDATE)
{
    ...
    var _morespeed = array(1, 1, 1, 1, 1, 1, 1, 1.3, 1.3, 1, 1, 1, 1, 1);
...
switch (argument0)
{
    ...
    case "cruiser":
        if (UPDATE)
        {
            var gun = multiply_array(_swarm, _BLANK);
    ...
    case "battle":
        if (UPDATE)
        {
            var gun = multiply_array(_swarm, _triple);
    ...
    case "defend":
        if (UPDATE)
        {
            var gun = multiply_array(_swarm, _halfreload);
            var trap = multiply_array(_trap, _halfreload, _halfrange);
    ...
    case "overseer":
        if (UPDATE)
        {
            var gun = multiply_array(_drone, _over);
            ds_list_add(gunsettings, gun, gun);
    ...
    case "artillery":
        if (UPDATE)
        {
            var gun = multiply_array(_basic, _gunner, _power);
            ds_list_add(gunsettings, gun, gun);
    ...
    case "mortar":
        if (UPDATE)
        {
            var gun = multiply_array(_basic, _twin, _gunner, _power);
            ds_list_add(gunsettings, gun, gun, gun, gun);
    ...
    case "spread":
        if (UPDATE)
        {
            var gun = multiply_array(_basic, _twin, _gunner, _power, _lowpower, _lessreload);
    ...
    case "wubdub":
        if (UPDATE)
        {
            var gun = multiply_array(_basic, _pound, _destroy, _halfreload);
    ...
    case "multirifle":
        if (UPDATE)
        {
            var gun = multiply_array(_basic, _sniper, _rifle, _lowpower, _halfreload, _halfrecoil);
    ...
    case "bentblaster":
        if (UPDATE)
        {
            var gun = multiply_array(_basic, _mach, _blaster, _bent, _halfrecoil);
            var lowpowergun = multiply_array(gun, _lowpower);
    ...
    case "ministream":
        if (UPDATE)
        {
            var gun = multiply_array(_basic, _ministream);
            ds_list_add(gunsettings, gun, gun, gun);
    ...
    case "stream":
        if (UPDATE)
        {
            var gun = multiply_array(_basic, _ministream, _ministream);
    ...
    case "hotshot":
        if (UPDATE)
        {
            var gun = multiply_array(_basic, _destroy, _ministream, _halfreload);
            ds_list_add(gunsettings, gun, gun, gun);
    ...
    case "tri":
        if (UPDATE)
        {
            ...
            var booster = multiply_array(_basic, _flank, _lowpower, _morerecoil);
    ...
    case "bomber":
        ...
        {
            var gun = multiply_array(_basic, _flank, _halfrecoil);
            var booster = multiply_array(_basic, _flank, _morerecoil);
            ds_list_add(gunsettings, gun, booster, booster);
    ...
    case "gunner":
        if (UPDATE)
        {
            var gun = multiply_array(_basic, _twin, _gunner);
            ds_list_add(gunsettings, gun, gun, gun, gun);
    ...
    case "heavy":
        ...
        {
            var gun = multiply_array(_basic, _twin, _gunner);
            var powergun = multiply_array(_basic, _twin, _gunner);
    ...
    case "doubletrap":
        ...
        {
            var gun = multiply_array(_basic, _twin);
            var tra = multiply_array(_trap, _twin);
    ...
    case "doublebent":
        if (UPDATE)
        {
            var gun = multiply_array(_basic, _twin, _bent);
            ds_list_add(gunsettings, gun, gun, gun, gun, gun, gun);
            _settings = multiply_array(array(1, 0.9, 1, 1, 1, 0), _settings);
        }
    ...
    case "penta":
        if (UPDATE)
        {
            var gun = multiply_array(_basic, _twin, _bent, _bent);
            ds_list_add(gunsettings, gun, gun, gun, gun, gun);
            _settings = multiply_array(array(1, 0.7, 1, 1, 1, 0), _settings);
        }
    ...
    case "dual":
        if (UPDATE)
        {
            var gun = multiply_array(_basic, _twin, _dual);
            var smallgun = multiply_array(_basic, _twin, _dual, _lowpower);
