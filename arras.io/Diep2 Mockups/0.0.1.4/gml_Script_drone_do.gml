...
{
    var n = instance_nearest(x, y, Foodstuffs);
    var dist = point_distance(n.x, n.y, control.x, control.y);
    ...
    {
        var dir = point_direction(control.x, control.y, x, y);
...
var l = length(x - target_x, y - target_y);
...
if (target_active)
{
    ...
    var desiredxspeed = (action * my_MaxSpeed * (x - target_x)) / l;
    var desiredyspeed = (action * my_MaxSpeed * (y - target_y)) / l;
