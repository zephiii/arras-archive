...
(function (root) {
    ...
    class Grid {
        ...
        expandGrid() {
            var i, currentCellCount = this.allCells.length, newCellCount = currentCellCount * 4 // double each dimension
                , newRowColumnCount = ~~Math.sqrt(newCellCount), newXYHashMask = newRowColumnCount - 1, allObjects = this.allObjects.slice(0);
            // remove all objects
