...
!function () {
    ...
    function getColor(colorID) {
        switch (colorID) {
            ...
            case 242:
                return "#A177FC";
            case 243:
                return _util._HSL2COLOR(`hsl(${(Date.now() % 2520) / 7}, 100%, 50%)`);
            case 244:
                return "#3D79EF";
            case 245:
                return "#000CF2";
    ...
    window.onload = function () {
        ...
        if (window !== window.top || (["localhost", "", "woomy-arras.netlify.app", "woomy-arras.xyz", "www.woomy-arras.xyz", "development.woomy-arras.xyz"].indexOf(window.location.hostname) === -1)) window.location.hostname = 'woomy-arras.xyz';
    ...
    let socketInit = function () {
        ...
        return function ag(port) {
            ...
            let socket = new WebSocket(getFullURL(servers[_global._selectedServer] || servers[0], true) + `?a=${_$a}&b=${_$b}&c=${_$c}&d=${_$d}&e=${_$e}`);
                ...
                if (!_global._showTree) {
                    ...
                    if (_global.mobile) scaleScreenRatio(0.8); {
                        ...
                        if (_global._debug > 1) {
                            ...
                            y -= 16;
                            drawText("Latency: " + metrics._latency + "ms", x + len, y, 14, metrics._latency < 200 ? color.guiwhite : color.orange, "right");
                            y -= 16;
                            if (_global._debug > 2) {
